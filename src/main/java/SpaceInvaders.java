...
public class SpaceInvaders extends JFrame implements Commons {
	 ...
	 * Inicio
	 */
	private static final String TOP_MESSAGE = "Pacheco Invaders <br> Java Version";
	private static final String INITIAL_MESSAGE = "Ajude-nos, capitão Pacheco!!"
			+ "<br>Os acadêmicos que atrapalham a aula estão tentando invadir nosso planeta."
			+ "<br><br><br>Sua missão:"
			+ "<br><br>Matar todos os acadêmicos falantes antes que eles consigam invadir a sala de aula."
			+ "<br>E, de preferência, não caia na conversa!"
			+ "<br><br><br>BOA SORTE!!!";
	/*
	 * Ajuda
	 */
	...
	private static final String HELP_MESSAGE = "Controles: " 
							...
							+ "<br><br>Soltar laser do passador de slides: <br>Barra de espaço";
	...
	public SpaceInvaders() {
		...
		frame2.setTitle("Pacheco Invaders");
